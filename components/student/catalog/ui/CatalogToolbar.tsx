    ...
    return (
        <section className="min-w-0">
            <div className="flex min-w-0 flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                            ...
                            (filter) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`inline-flex h-10 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black transition active:scale-[0.97] sm:h-11 sm:rounded-2xl sm:px-5 sm:text-sm ${active
                ...
                <div className="grid min-w-0 gap-2 sm:grid-cols-[minmax(0,1fr)_170px_auto_auto] xl:w-[min(100%,850px)]">
                    ...
                    <button
                        ...
                        className={`inline-flex h-10 items-center justify-center gap-2 rounded-xl border px-4 text-xs font-black shadow-sm transition active:scale-[0.97] sm:h-11 sm:rounded-2xl sm:text-sm ${showExtraFilters ||
                                catalog.catalogFilter ===
                                "offers"
                    ...
                    >
                        ...
                        <ChevronDown
                            aria-hidden="true"
                            className={`h-4 w-4 transition ${showExtraFilters
                                    ? "rotate-180"
                                    : ""
                                }`}
                        />
                    ...
                    <button
                        ...
                        className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 text-xs font-black text-slate-700 shadow-sm transition hover:bg-slate-50 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-60 sm:h-11 sm:rounded-2xl sm:text-sm"
                    >
                        <RefreshCw
                            aria-hidden="true"
                            className={`h-4 w-4 ${catalog.refreshing
                                    ? "animate-spin"
                                    : ""
                                }`}
                        />
            ...
            {showExtraFilters ? (
                <div className="mt-2 flex min-w-0 flex-wrap items-center gap-2 rounded-xl border border-orange-100 bg-orange-50/70 p-2 sm:rounded-2xl sm:p-3">
                    ...
                    <button
                        ...
                        className={`inline-flex h-8 items-center justify-center rounded-xl px-3 text-[11px] font-black transition active:scale-[0.97] sm:h-9 sm:text-xs ${catalog.catalogFilter ===
                                "offers"
