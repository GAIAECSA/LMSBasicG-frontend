...
/*
 * Este componente ya no muestra ningún selector
 * de cursos.
 *
 * El curso debe venir directamente desde la ruta:
 *
 * ADMIN:
...
export function TeacherAttendanceWorkspace({
    ...
    /*
     * Si por alguna razón se entra a la página
     * sin courseId, no mostramos CourseSelect.
     *
     * La ruta debe ser dinámica y entregar el ID.
     */
    if (!currentCourseId) {
        return (
            <section className="min-h-screen bg-slate-50 px-3 py-3 text-slate-950 sm:px-4 sm:py-4 lg:px-5 xl:px-6">
                <div className="mx-auto flex min-h-[60vh] w-full max-w-[1480px] items-center justify-center">
                    <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm sm:rounded-[2rem] sm:p-8">
                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-orange-50 text-orange-600">
                            <ClipboardCheck className="h-7 w-7" />
                        </div>

                        <h1 className="mt-4 text-xl font-black text-slate-950 sm:text-2xl">
                            Curso no seleccionado
                        </h1>

                        <p className="mt-2 text-sm font-semibold leading-6 text-slate-500">
                            La asistencia docente necesita
                            recibir el ID del curso desde la
                            ruta.
                        </p>

                        <p className="mt-3 rounded-xl bg-slate-50 px-4 py-3 text-xs font-bold text-slate-600">
                            Ejemplo:
                            <br />
                            <span className="text-[#172861]">
                                /admin/attendance/teacher/123
                            </span>
                        </p>
                    </div>
                </div>
                    ...
                    <div className="bg-gradient-to-br from-[#07122f] via-[#172b78] to-orange-500 px-4 py-4 text-white sm:px-5 sm:py-5 lg:px-6 [@media(max-height:760px)]:py-4">
                        ...
                        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-center">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="mt-3 inline-flex rounded-xl bg-white/10 px-3 py-1.5 text-[11px] font-black text-white/90">
                                    Curso #{courseId}
                                </p>
                            </div>
