        ...
        <div className="flex flex-col gap-3 border-t border-slate-200 px-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-4 lg:px-5 [@media(max-height:760px)]:py-2.5">
            ...
            <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 sm:flex">
                <button
                    ...
                    className="inline-flex h-9 items-center justify-center gap-1 rounded-xl border border-slate-200 px-3 text-xs font-bold text-slate-500 transition hover:bg-slate-50 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50 sm:h-10 sm:px-4 sm:text-sm"
