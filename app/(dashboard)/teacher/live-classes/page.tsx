            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-slate-600">
                            Seleccione uno de sus cursos para programar reuniones, iniciar clases y administrar grabaciones.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                    <p className="text-sm leading-6 text-slate-600">
                        En la siguiente fase agregaremos aquí las tarjetas de sus cursos asignados reutilizando su servicio actual de cursos.
                    </p>
