...
import { CourseSelectMdtFiles } from "@/components/teacher/mdt-certificados/ui/CourseSelectMdtFiles";
...
export default function AdminMdtRequiredFilesPage() {
    ...
    useEffect(() => {
        ...
        async function loadCourses() {
            try {
                ...
                console.error("Error al cargar cursos para archivos MDT:", currentError);
    ...
    function handleSelectCourse(value: string) {
        ...
        router.push(`/admin/mdt-required-files/${courseId}`);
    }
